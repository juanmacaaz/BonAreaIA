...
data_folder = os.path.join(get_parent_dir(n=0))
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--ip_dir",
        type=str,
        default='http://localhost:3000/update',
        help="IP dir from server"
    )
    ...
    parser.add_argument(
        ...
        dest="postfix",
        default="_void",
        help='Specify the postfix for images with bounding boxes. Default is "_void"',
    )
    ...
    if input_image_paths and not webcam_active:
        ...
        for i, img_path in enumerate(input_image_paths):
            ...
            myobj = {'Prestatge': '1', 'Ubicacion': 'Sector 3 Zona 2'}
            myobj['void'] = len(prediction)
            x = requests.post(FLAGS.ip_dir, data = myobj)
        end = timer()
        print(
